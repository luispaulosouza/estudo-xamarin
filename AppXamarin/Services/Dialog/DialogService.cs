...
namespace AppXamarin.Services.Dialog
{
    public class DialogService
    {
        static Lazy<DialogService> LazyNavi = new Lazy<DialogService>(() => new DialogService());
        public static DialogService Current => LazyNavi.Value;
